...
public class weibo_sample_multi_3 extends Thread {
    //处理非历史xz数据

    public Integer index;

    public weibo_sample_multi_3() {

    }

    public weibo_sample_multi_3(Integer _index) {
        index = _index;
    }
    ...
    public void run() {
        try {
            ...
            OutputStreamWriter writer = new OutputStreamWriter(
                    new FileOutputStream(new File("D:\\Program\\dong\\xz\\" + index + "_weibo_india.txt")), "utf-8");

            String filepath = String.format("D:\\Data\\WeiboWechat\\Weibo1\\weibo\\10\\%d.txt.xz", index);
    ...
    public static void main(String args[]) {
        ...
        for (int i = 730; i <= 873; i++) {
            Thread t = new weibo_sample_multi_3(i);
            t.start();
        }
...
/*
        ...
        try {
            ...
            String filepath = String.format("D:\\GitHub\\weibo_weixin_sample\\data\\%d.txt.xz", index);
            File curF = new File(filepath);
            if (!curF.exists())
                return;
